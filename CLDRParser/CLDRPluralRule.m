    ...
    dispatch_once(&onceToken, ^{
        rules = @{
                  ...
                  @"tl": ^(CLDRPluralOperands * o){
                      unsigned long a1 = fmod(o.i, 10), a2 = fmod(o.f, 10);
                  ...
                  @"tzm": ^(CLDRPluralOperands * o){
                      if ((o.n <= 1) || ((11 <= o.n && o.n <= 99))) return @"one";
                      return @"other";
                  },
                  ...
                  @"iw": ^(CLDRPluralOperands * o){
                      ...
                      if ((o.v == 0 && !(o.n <= 10) && fmod(o.n, 10) == 0)) return @"many";
                      return @"other";
                  },
                  ...
                  @"lt": ^(CLDRPluralOperands * o){
                      unsigned long a1 = fmod(o.n, 100), a2 = fmod(o.n, 10);
                      if ((a2 == 1 && !((11 <= a1 && a1 <= 19)))) return @"one";
                      if ((((2 <= a2 && a2 <= 9)) && !((11 <= a1 && a1 <= 19)))) return @"few";
                  ...
                  @"lv": ^(CLDRPluralOperands * o){
                      unsigned long a1 = fmod(o.n, 100), a2 = fmod(o.n, 10), a3 = fmod(o.f, 10), a4 = fmod(o.f, 100);
                      if ((a2 == 1 && !(a1 == 11)) || (o.v == 2 && a3 == 1 && !(a4 == 11)) || (!(o.v == 2) && a3 == 1)) return @"one";
                      if (a2 == 0 || ((11 <= a1 && a1 <= 19)) || (o.v == 2 && ((11 <= a4 && a4 <= 19)))) return @"zero";
                      return @"other";
                  },
                  ...
                  @"ro": ^(CLDRPluralOperands * o){
                      unsigned long a1 = fmod(o.n, 100);
                      if ((o.i == 1 && o.v == 0)) return @"one";
                      if (!(o.v == 0) || o.n == 0 || (!(o.n == 1) && ((1 <= a1 && a1 <= 19)))) return @"few";
                      return @"other";
                  },
                  @"ar": ^(CLDRPluralOperands * o){
                      unsigned long a1 = fmod(o.n, 100);
                      if (o.n == 1) return @"one";
                      if (((3 <= a1 && a1 <= 10))) return @"few";
                      if (o.n == 0) return @"zero";
                      if (o.n == 2) return @"two";
                      if (((11 <= a1 && a1 <= 99))) return @"many";
                      return @"other";
                  },
                  @"uk": ^(CLDRPluralOperands * o){
                      unsigned long a1 = fmod(o.i, 100), a2 = fmod(o.i, 10);
                  ...
                  @"be": ^(CLDRPluralOperands * o){
                      ...
                      if ((((2 <= a2 && a2 <= 4)) && !((12 <= a1 && a1 <= 14)))) return @"few";
                      if (a2 == 0 || ((5 <= a2 && a2 <= 9)) || ((11 <= a1 && a1 <= 14))) return @"many";
                      return @"other";
                  },
                  ...
                  @"sh": ^(CLDRPluralOperands * o){
                      unsigned long a1 = fmod(o.f, 100), a2 = fmod(o.f, 10), a3 = fmod(o.i, 100), a4 = fmod(o.i, 10);
                  ...
                  @"si": ^(CLDRPluralOperands * o){
                      if ((o.n <= 1) || (o.i == 0 && o.f == 1)) return @"one";
                      return @"other";
                  },
                  @"mt": ^(CLDRPluralOperands * o){
                      unsigned long a1 = fmod(o.n, 100);
                      if (o.n == 1) return @"one";
                      if (o.n == 0 || ((2 <= a1 && a1 <= 10))) return @"few";
                      if (((11 <= a1 && a1 <= 19))) return @"many";
                      return @"other";
                  },
                  ...
                  @"br": ^(CLDRPluralOperands * o){
                      ...
                      if ((((3 <= a2 && a2 <= 4) || a2 == 9) && !((10 <= a1 && a1 <= 19) || (70 <= a1 && a1 <= 79) || (90 <= a1 && a1 <= 99)))) return @"few";
